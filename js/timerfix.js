...
var k;k=b instanceof Object||b instanceof createjs.PlayPropsConfig?createjs.PlayPropsConfig.create(b):createjs.PlayPropsConfig.create({interrupt:b,delay:d,offset:e,loop:f,volume:g,pan:h,startTime:i,duration:j});var l=createjs.Sound.createInstance(a,k.startTime,k.duration),m=createjs.Sound._playInstance(l,k);return m||l._playFailed(),l;};function getChromeVersion()
